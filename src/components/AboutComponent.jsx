...
const AboutComponent = () =>{
    return (
        <Container className='About mb-20 d-flex align-items-center' fluid>
            <Row className='About-content col-12 d-flex justify-content-center m-2'>
                <Col className='d-flex justify-content-center col-12'>
                    <img className='About-SVG align-self-center' src={logo} alt=''/>
                </Col>
                <Col className='col-12 col-sm-11 col-lg-6 d-flex align-items-center justify-content-center' style={{ textAlign: "justify" }}>
                    <p className='p-2'>STKT Beauty and Technology  — STKT Beauty & Technology is a company fueled by a singular mission: revolutionizing the salon industry through our innovative platform, VYLEE.
