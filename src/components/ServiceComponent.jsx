    ...
    return (
        ...
        <Row className='h-10'>
            <Col className='Header d-flex text-center justify-content-center'>
                <h2 className="decorated"><span>Our Services</span></h2> 
            </Col>
        </Row>
        <Row className='h-80'>
        ...
        <Row className='h-10'>
            <Col className='text-center mt-2 mb-4'>
                <Button size="lg" variant="primary" href='https://b339878.yclients.com/company/325582/menu?o='>Explore our     Services!</Button>{' '}
            </Col>
        </Row>
    </Container>
    )
